...
export function Footer() {
  return (
    <section title="footer" className="w-full bg-[#16423C] overflow-hidden">
          ...
          <div className="w-full sm:flex flex-wrap justify-between gap-y-8">
            <div className="flex px-2 mb-4">
              <div className="text-left">
                <h2 className="text-xl pt-2 font-extrabold font-md text-gray-100 capitalize">Company Name</h2>
                <p className="pt-2 text-sm font-md text-gray-100">Lorem, ipsum dolor.</p>
              </div>
            </div>
